...
exports.create = (req, res) => {
    ...
    ProductsCategory.create(productsCategory).then(data => {
...
exports.findAll = (req, res) => {
    ...
    ProductsCategory.findAll({ where: condition }).then(data => {
        res.status(200).send(data);
    }).catch(err => {
        res.status(500).send({
...
exports.findOne = (req, res) => {
    ...
    ProductsCategory.findByPk(id, {where: {deletedAt: null}}).then(data => {
...
exports.update = (req, res) => {
    ...
    ProductsCategory.update(req.body, {
