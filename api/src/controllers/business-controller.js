// Aquí está el controlador de business:
...
exports.create = (req, res) => {
    ...
    if (!req.body.business_name || !req.body.trade_name || !req.body.cif || !req.body.address || !req.body.location || !req.body.phone || !req.body.email || !req.body.web) {
...
exports.findOne = (req, res) => {
    ...
    Business.findByPk(id, {where: {deletedAt: null}}).then(data => {
